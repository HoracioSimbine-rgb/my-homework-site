...
// -----------------------------------------------------------------
// 2. DATABASE (All 36 Businesses with Ratings & Reviews added)
// -----------------------------------------------------------------
const businesses: Business[] = [
  { id: 1, name: "Maputo Fresh Groceries", category: "Retalho", location: "Maputo", price: "500 MZN", rating: 4.8, reviews: 124, description: "Produtos locais frescos e orgânicos entregues diretamente por agricultores moçambicanos.", image: "https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=600&auto=format&fit=crop" },
  { id: 2, name: "Matola Tech Repair", category: "Serviços", location: "Matola", price: "1,000 MZN", rating: 4.5, reviews: 89, description: "Reparações rápidas e fiáveis de telemóveis e computadores por técnicos certificados.", image: "https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?q=80&w=600&auto=format&fit=crop" },
  { id: 3, name: "Beira Bite Cafe", category: "Restauração", location: "Beira", price: "150 MZN", rating: 4.9, reviews: 210, description: "O melhor café artesanal, pastelaria fresca e um espaço de trabalho relaxante na cidade.", image: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=600&auto=format&fit=crop" },
  { id: 4, name: "Nampula Textiles", category: "Moda", location: "Nampula", price: "800 MZN", rating: 4.7, reviews: 56, description: "Capulanas tradicionais autênticas e roupa feita à medida com um toque moderno.", image: "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?q=80&w=600&auto=format&fit=crop" },
  { id: 5, name: "Pemba Ocean Tours", category: "Serviços", location: "Pemba", price: "3,500 MZN", rating: 5.0, reviews: 342, description: "Mergulho guiado e passeios de barco para explorar o belo Arquipélago das Quirimbas.", image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=600&auto=format&fit=crop" },
  { id: 6, name: "Tete Mining Supplies", category: "Retalho", location: "Tete", price: "Consulta", rating: 4.2, reviews: 34, description: "Equipamento industrial e de segurança de alta qualidade para construtores locais.", image: "https://images.unsplash.com/photo-1572981779307-38b8cabb2407?q=80&w=600&auto=format&fit=crop" },
  { id: 7, name: "Zambezia Organic Tea", category: "Restauração", location: "Gurué", price: "300 MZN", rating: 4.6, reviews: 45, description: "Folhas de chá premium, cultivadas e colhidas localmente nas montanhas de Gurué.", image: "https://images.unsplash.com/photo-1582793988951-9aed5509eb97?q=80&w=600&auto=format&fit=crop" },
  { id: 8, name: "Inhambane Surf Shop", category: "Retalho", location: "Tofo", price: "1,500 MZN", rating: 4.8, reviews: 178, description: "Aluguer de pranchas de surf, roupa de praia e aulas para todos os níveis.", image: "https://images.unsplash.com/photo-1502680390469-be75c86b636f?q=80&w=600&auto=format&fit=crop" },
  { id: 9, name: "Chimoio Agro-Tech", category: "Tecnologia", location: "Chimoio", price: "5,000 MZN", rating: 4.4, reviews: 67, description: "Soluções de agricultura inteligente para ajudar os agricultores locais a aumentar o rendimento.", image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=600&auto=format&fit=crop" },
  { id: 10, name: "Vilankulo Seaside Clinic", category: "Saúde", location: "Vilankulo", price: "2,500 MZN", rating: 4.9, reviews: 230, description: "Cuidados de saúde comunitários dedicados, farmácia e serviços médicos de emergência.", image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=600&auto=format&fit=crop" },
  { id: 11, name: "Maputo Code Academy", category: "Tecnologia", location: "Maputo", price: "15,000 MZN", rating: 4.7, reviews: 112, description: "Bootcamps de programação presenciais para a próxima geração de programadores.", image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=600&auto=format&fit=crop" },
  { id: 12, name: "Xai-Xai Auto Repair", category: "Serviços", location: "Xai-Xai", price: "4,000 MZN", rating: 4.3, reviews: 88, description: "Mecânicos de confiança que fornecem manutenção completa de veículos e diagnósticos.", image: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?q=80&w=600&auto=format&fit=crop" },
  { id: 13, name: "Nacala Port Logistics", category: "Serviços", location: "Nacala", price: "Consulta", rating: 4.1, reviews: 29, description: "Soluções eficientes de transporte e armazenamento perto do porto de águas profundas.", image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=600&auto=format&fit=crop" },
  { id: 14, name: "Quelimane Seafood Catch", category: "Restauração", location: "Quelimane", price: "1,200 MZN", rating: 4.8, reviews: 156, description: "Capturas diárias de camarão, caranguejo e peixe diretamente da costa da Zambézia.", image: "https://images.unsplash.com/photo-1615141982883-c7ad0e69fd62?q=80&w=600&auto=format&fit=crop" },
  { id: 15, name: "Maxixe Transport Hub", category: "Serviços", location: "Maxixe", price: "800 MZN", rating: 4.0, reviews: 310, description: "Reservas fiáveis de autocarros interurbanos e aluguer de transportes privados.", image: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=600&auto=format&fit=crop" },
  { id: 16, name: "Lichinga Pine Furniture", category: "Retalho", location: "Lichinga", price: "8,500 MZN", rating: 4.6, reviews: 72, description: "Mobiliário bonito, durável e feito à mão com pinho do Niassa.", image: "https://images.unsplash.com/photo-1538688525198-9b88f6f53126?q=80&w=600&auto=format&fit=crop" },
  { id: 17, name: "Maputo Fitness Oasis", category: "Saúde", location: "Maputo", price: "3,500 MZN", rating: 4.7, reviews: 198, description: "Equipamento de ginásio de última geração, treino personalizado e aulas de bem-estar.", image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=600&auto=format&fit=crop" },
  { id: 18, name: "Gorongosa Eco-Lodge", category: "Serviços", location: "Gorongosa", price: "6,000 MZN", rating: 4.9, reviews: 405, description: "Alojamento de safari sustentável com visitas guiadas ao parque nacional.", image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=600&auto=format&fit=crop" },
  { id: 19, name: "Matola Artisan Bakery", category: "Restauração", location: "Matola", price: "20 MZN", rating: 4.8, reviews: 312, description: "Pão quente, bolos e salgados tradicionais moçambicanos acabados de fazer.", image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=600&auto=format&fit=crop" },
  { id: 20, name: "Beira Enterprise IT", category: "Tecnologia", location: "Beira", price: "10,000 MZN", rating: 4.5, reviews: 42, description: "Instalações de rede, cibersegurança e soluções na cloud para empresas.", image: "https://i.pinimg.com/1200x/57/8b/03/578b0347823fbbad10aaa24502e96e2a.jpg" },
  { id: 21, name: "Maputo Modern Boutique", category: "Moda", location: "Maputo", price: "2,500 MZN", rating: 4.6, reviews: 88, description: "Roupa urbana contemporânea que mistura o estilo moderno com estampas africanas.", image: "https://i.pinimg.com/1200x/7a/74/11/7a7411fb68c9f93127c3095693991966.jpg" },
  { id: 22, name: "Vilankulo Craft Market", category: "Retalho", location: "Vilankulo", price: "500 MZN", rating: 4.7, reviews: 156, description: "Esculturas em madeira feitas à mão, cestos tecidos e belas lembranças turísticas.", image: "https://i.pinimg.com/1200x/be/86/36/be86368d334fd54ad8c4ef9b8f97a60e.jpg" },
  { id: 23, name: "Tete Smile Dental", category: "Saúde", location: "Tete", price: "3,000 MZN", rating: 4.9, reviews: 110, description: "Cuidados dentários profissionais, limpezas e ortodontia para toda a família.", image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=600&auto=format&fit=crop" },
  { id: 24, name: "Maputo Cleaning Pros", category: "Serviços", location: "Maputo", price: "1,500 MZN", rating: 4.4, reviews: 65, description: "Limpeza profunda, manutenção de escritórios e serviços de limpeza residencial.", image: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&auto=format&fit=crop" },
  { id: 25, name: "Pemba Beach Bar", category: "Restauração", location: "Pemba", price: "400 MZN", rating: 4.8, reviews: 289, description: "Cocktails ao pôr do sol, sumos naturais e marisco grelhado na areia branca.", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=600&auto=format&fit=crop" },
  { id: 26, name: "Nampula Cyber Cafe", category: "Tecnologia", location: "Nampula", price: "50 MZN", rating: 4.2, reviews: 94, description: "Acesso à internet de alta velocidade, serviços de impressão e aluguer.", image: "https://i.pinimg.com/1200x/8f/ca/52/8fca52e933a45ffc6551fff185dcdd81.jpg" },
  { id: 27, name: "Xai-Xai Tailors", category: "Moda", location: "Xai-Xai", price: "6,000 MZN", rating: 4.7, reviews: 51, description: "Alterações especializadas, fatos à medida e trajes de casamento personalizados.", image: "https://i.pinimg.com/736x/d6/c5/50/d6c5506652a9d91cf621e71436244726.jpg" },
  { id: 28, name: "Chimoio Builders Hardware", category: "Retalho", location: "Chimoio", price: "450 MZN", rating: 4.5, reviews: 134, description: "Tudo o que precisa para projetos de bricolage, renovações domésticas e construção.", image: "https://i.pinimg.com/736x/2e/14/40/2e14408498bd5ffddb5cd60626d97a8a.jpg" },
  { id: 29, name: "Tofo Scuba Academy", category: "Serviços", location: "Tofo", price: "20,000 MZN", rating: 5.0, reviews: 215, description: "Cursos de mergulho certificados pela PADI e emocionantes safaris de tubarão-baleia.", image: "https://i.pinimg.com/1200x/51/35/99/513599a7b70bbcc1ddb68765e534cd1e.jpg" },
  { id: 30, name: "Quelimane Books & Supplies", category: "Retalho", location: "Quelimane", price: "800 MZN", rating: 4.6, reviews: 77, description: "Manuais escolares, material de escritório e literatura de autores africanos.", image: "https://i.pinimg.com/736x/04/84/fe/0484febddccec679db26924007e08390.jpg" },
  { id: 31, name: "Gurué Mountain Yoga", category: "Saúde", location: "Gurué", price: "600 MZN", rating: 4.9, reviews: 102, description: "Retiros pacíficos de ioga, aulas de meditação e workshops de bem-estar holístico.", image: "https://i.pinimg.com/736x/16/ae/8b/16ae8b2f69472f9cdf93ddcb32b015e6.jpg" },
  { id: 32, name: "Maputo Sky Drones", category: "Tecnologia", location: "Maputo", price: "8,000 MZN", rating: 4.8, reviews: 63, description: "Fotografia aérea profissional, videografia e serviços de levantamento topográfico.", image: "https://i.pinimg.com/736x/ab/79/69/ab79691c3a89be7379c3fb17000ce835.jpg" },
  ...
  { id: 34, name: "Nacala Vision Center", category: "Saúde", location: "Nacala", price: "4,500 MZN", rating: 4.5, reviews: 89, description: "Exames oftalmológicos, óculos graduados elegantes e óculos de sol com proteção UV.", image: "https://i.pinimg.com/1200x/10/f9/33/10f933c24f8030e57291b6f4712d6676.jpg" },
  { id: 35, name: "Beira Leather Goods", category: "Moda", location: "Beira", price: "1,200 MZN", rating: 4.6, reviews: 115, description: "Carteiras de couro costuradas à mão, cintos e sacos de viagem de luxo.", image: "https://images.unsplash.com/photo-1470309864661-68328b2cd0a5?q=80&w=600&auto=format&fit=crop" },
  { id: 36, name: "Lichinga Cold Storage", category: "Serviços", location: "Lichinga", price: "Consulta", rating: 4.3, reviews: 22, description: "Refrigeração comercial e soluções de armazenamento congelado para empresas agrícolas.", image: "https://i.pinimg.com/736x/37/e8/4a/37e84a376571d9bf520cecfc4da49ed1.jpg" }
];
...
export default function Home() {
  ...
  const [selectedProfile, setSelectedProfile] = useState<Business | null>(null); // Controls the Profile Modal

  // THE SEARCH LOGIC: Filters based on what the user types in the search bar
        ...
        <div className="relative z-10 max-w-4xl mx-auto mt-8 md:mt-0">
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-full p-2 flex shadow-2xl border-4 border-white/20 items-center">
            ...
            <input 
              type="search" 
              enterKeyHint="search"
              placeholder="Pesquisar empresas, cidades ou palavras-chave..." 
            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 pb-6 border-b border-gray-100 gap-4">
                ...
                <div className="text-left md:text-right bg-gray-50 p-3 rounded-xl border border-gray-100 w-full md:w-auto">
                  <p className="text-sm text-gray-500 font-bold mb-1">Preço Médio</p>

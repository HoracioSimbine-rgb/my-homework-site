      ...
      <section className="max-w-3xl mx-auto px-6 py-12 flex-grow w-full flex items-center justify-center">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 relative overflow-hidden w-full">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* THE PHONE NUMBER FIELD IS BACK! type="tel" opens the mobile number pad */}
            <div>
              <label htmlFor="phone" className="block text-sm font-bold text-gray-700 mb-2">Telefone (Opcional)</label>
              <input type="tel" id="phone" className="w-full px-4 py-3 min-h-[44px] rounded-xl border-2 border-gray-200 focus:ring-0 focus:border-blue-600 outline-none transition-all bg-gray-50 focus:bg-white" placeholder="+258 84 123 4567" />
            </div>

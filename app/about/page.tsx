    ...
    <main className="min-h-screen bg-gray-50 p-8 text-gray-800">
      <div className="max-w-2xl mx-auto bg-white p-10 rounded-lg shadow-md mt-10">
        ...
        <p className="text-lg mb-4">
          This platform was created to help connect citizens with local small businesses across Mozambique. 
          By shopping local, we strengthen our community and local economy.
        </p>
        
        <p className="text-lg mb-8">
          This project was built using <strong>Next.js</strong> and Tailwind CSS.
        </p>
